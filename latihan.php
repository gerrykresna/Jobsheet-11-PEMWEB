...
<form> 
<pre>
    User ID       : <input type=text name=userid id=userid onblur=cekid()> <span
    id=teks style="color:red;font-size:8pt"></span> <br> 
    Nama Lengkap  : <input type=text name=nama id=nama onblur=ceknama()> <span
    id=teks5 style="color:red;font-size:8pt"></span> <br> 
    Email         : <input type=text name=email id=email onblur=cekemail() > <span 
    id=teks2 style="color:red;font-size:8pt"></span> <br> 
    Umur          : <input type=text name=umur id=umur onblur=cekumur() > <span 
    id=teks3 style="color:red;font-size:8pt"></span> <br> 
    Provinsi      : <?php 
